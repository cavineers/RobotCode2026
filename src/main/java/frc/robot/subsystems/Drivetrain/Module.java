...
public class Module {
    ...
    /** 
     * Returns the module velocity in rad/sec at the WHEEL.
     * Used for feedforward characterization - matches the velocity units commanded in runSetpoint() (wheel rad/s).
     */
