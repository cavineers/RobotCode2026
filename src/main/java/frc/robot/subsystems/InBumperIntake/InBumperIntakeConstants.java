...
public class InBumperIntakeConstants {
    ...
    public static final int kHopperMotorCanID = 35 ; //TODO: set actual id
    ...
    public static final boolean kHopperInverted = true;
    public static final IdleMode kHopperIdleMode = IdleMode.kCoast;
